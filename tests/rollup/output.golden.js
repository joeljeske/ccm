import require$$0, { forwardRef, createElement } from 'react';
...
const createComponent = (name, base, modifiers, properties) => {
  const componentCache = new Map();

  function createReactCCMComponent(tag) {
    const Component = forwardRef((props, ref) => {
      const style = {}; // Start off with our base component className,
      ...
      return createElement(tag, Object.assign(Object.assign({}, remainingProps), {
        ref,
    ...
    Component.displayName = `CCM-${name}.${typeof tag === "string" ? tag : tag.displayName || tag.name}`;
    return Component;
  }

  const lookupComponent = tag => {
...
/* Auto generated CSS file from: "app.ccm.css" */
/** Base AppContainer component */

const AppContainer = createComponent("AppContainer",
/* Base Element Class */
"AppContainer_cf5704abd44",
/* CSS Modifier Class Mappings */
{},
/* CSS Custom Property Mappings */
{});
/** Base AppTitle component */

const AppTitle = createComponent("AppTitle",
/* Base Element Class */
"AppTitle_cb2c6b615ae",
/* CSS Modifier Class Mappings */
{},
/* CSS Custom Property Mappings */
{
  "$--titleColor": "--titleColor_cdcb5802324"
});
...
const App = () => {
  return /*#__PURE__*/jsxRuntime.exports.jsx(AppContainer.div, {
    children: /*#__PURE__*/jsxRuntime.exports.jsx(AppTitle.h1, {
      "$--titleColor": "red",
...
reactDom.exports.render( /*#__PURE__*/jsxRuntime.exports.jsx(App, {}), document.getElementById('app'));
